# https://github.com/mnot/redbot/blob/main/redbot/syntax/rfc5646.py
"""
Regex for RFC5646
...
## The last two match almost anything and would require checking the list of registered language subtags, currently no such entries exist
#language = rf"""(?:
#  {ALPHA}{{2,3}}
#  (?: \- {extlang} )?
#| {ALPHA}{{4}}

# https://github.com/mnot/redbot/blob/main/redbot/syntax/rfc7231.py
"""
Regex for RFC7231
...
Accept = list_rule(rf"(?: {media_range} (?: {accept_params} )? )", 0)
...
Accept_Encoding = list_rule(rf"(?: {codings} {weight}? )", 0)
